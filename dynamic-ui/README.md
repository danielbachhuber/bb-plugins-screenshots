...
After "Post, approve, and merge": with nothing left open, the list above the composer collapses to its header, and the Done checkbox there hides it. The panel shows the draft as posted.
