...
One list of what needs doing now, from Todoist and your Gmail inbox, with GitHub notifications gathered per pull request or issue and Google Docs comments per document. Complete tasks, archive email, answer calendar invitations, snooze anything, reply on GitHub, merge your own pull requests, and start a thread from any row.
