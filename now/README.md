...
One list of what needs doing now, from Todoist and your Gmail inbox, with GitHub notifications gathered per pull request or issue, showing each pull request's reviewers, and Google Docs comments per document. Complete, reschedule, reprioritize, move, or delete tasks, archive email or mark it read, answer calendar invitations, reply on GitHub, merge your own pull requests, and start a thread from any row.
